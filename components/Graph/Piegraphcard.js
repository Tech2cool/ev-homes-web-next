          ...
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
              ...
              >
                ...
                <tspan x="50%" dy="1.0em" fontSize={20} fill={colors[1]}>
                  {percentage}
                </tspan>
                <tspan dy="1.6em" fill="grey" fontSize={12} x="50%">
                  Total
                </tspan>
                <tspan dy="2.0em" fill={colors[0]} fontSize={10} x="50%">
                  {lableone} : {valueone}
                </tspan>
                <tspan dy="1.2em" fill={colors[1]} fontSize={10} x="50%">
                  {labletwo} : {valuetwo}
                </tspan>
              </text>
            </PieChart>
